...
Un **proyecto** es un esfuerzo organizado, de carácter temporal, que se realiza para crear un producto, servicio, resultado o cambio determinado y que se desarrolla bajo unas condiciones concretas de alcance, plazo, recursos, coste, calidad, riesgo y expectativas de los interesados.

De esta definición se extraen dos ideas esenciales:

- **Temporalidad:** tiene un comienzo y un final definidos. Temporal no significa necesariamente breve.
- **Singularidad:** produce algo que, considerado en su contexto, no es idéntico a la actividad ordinaria y repetitiva de la organización.
...
La **dirección de proyectos** consiste en aplicar conocimientos, capacidades, métodos, prácticas, herramientas y técnicas para conducir el trabajo del proyecto y lograr los resultados esperados.
...
Todo proyecto tiene un comienzo y un final. Los productos, servicios o beneficios que origina pueden perdurar después del cierre.

Ejemplo: el proyecto de construcción de un centro de datos finaliza, pero el centro puede operar durante décadas.

### Singularidad

El resultado presenta algún grado de novedad. Dos proyectos pueden ser similares, pero las diferencias de interesados, ubicación, tecnología, regulación, equipo, plazo o contexto los hacen singulares.

### Orientación a objetivos y valor

El proyecto no existe únicamente para ejecutar tareas. Debe generar entregables que faciliten resultados, beneficios y valor para la organización o la sociedad.

### Elaboración progresiva

La información se desarrolla y concreta a medida que aumenta el conocimiento. Esta elaboración progresiva no equivale a introducir cambios sin control: el detalle puede crecer sin alterar arbitrariamente los objetivos aprobados.

### Incertidumbre y riesgo

Al abordar algo singular y futuro, nunca se dispone de información perfecta. La incertidumbre puede generar amenazas, pero también oportunidades.

### Interdisciplinariedad

Muchos proyectos requieren perfiles de distintas áreas: negocio, tecnología, contratación, seguridad, protección de datos, finanzas, comunicación y operación.

### Limitación de recursos

Los recursos son finitos. El equipo debe priorizar y equilibrar alcance, plazo, coste, calidad, riesgo, capacidad y valor.

### Presencia de múltiples interesados

Los interesados pueden tener objetivos, poder, urgencia y expectativas diferentes. El éxito técnico no garantiza la aceptación organizativa.

### Cambio organizativo

Los proyectos suelen introducir cambios en procesos, tecnologías, estructuras, capacidades o comportamientos. Por ello, la gestión del cambio organizativo puede ser decisiva.
...
| **Desbeneficio** | Consecuencia negativa medible aceptada como parte del cambio. | Mayor carga inicial de soporte digital para ciertos usuarios. |
| **Valor** | Importancia, utilidad o ventaja global obtenida, considerando beneficios, costes, riesgos y efectos para los interesados. | Servicio más accesible y eficiente con un coste sostenible. |

### Cadena lógica

**Necesidad → proyecto → entregables → resultados → beneficios → valor**

El proyecto controla directamente la creación y aceptación de los entregables. La obtención de beneficios puede depender también de la adopción, la operación y el uso posterior.
...
La evaluación moderna del éxito no debe limitarse a la llamada triple restricción.

1. **Eficiencia de la ejecución:** plazo, coste, alcance y utilización de recursos.
2. **Calidad y aceptación de entregables:** conformidad con requisitos y aptitud para el uso.
3. **Resultados y beneficios:** mejoras efectivamente logradas.
4. **Valor estratégico o público:** contribución a objetivos organizativos o sociales.
5. **Satisfacción y confianza de los interesados.**
6. **Sostenibilidad y efectos a largo plazo.**
7. **Capacidad organizativa generada:** aprendizaje, conocimiento y madurez.

### Triple restricción y restricciones ampliadas
...
## 2.3.1. Qué es un principio

Un **principio** es una orientación fundamental que guía comportamientos y decisiones. No prescribe una única técnica ni una secuencia exacta de procesos. Su aplicación debe adaptarse al contexto.
...
- ¿Siguen siendo justificables los costes y riesgos?
- ¿Existe una alternativa mejor?

Si el proyecto deja de ser justificable, la decisión correcta puede ser modificarlo, pausarlo o cerrarlo.
...
La participación no equivale a informar a todos de todo. Consiste en identificar interesados, comprender sus necesidades e influencia, decidir el grado apropiado de involucración y mantener relaciones que favorezcan los objetivos.
...
El proyecto es parte de un sistema. Una decisión localmente óptima puede causar un efecto negativo global.

Ejemplo: acelerar el desarrollo omitiendo documentación puede cumplir un hito, pero aumentar costes de mantenimiento y dependencia del proveedor.

### Adaptación al contexto o *tailoring*
...
La calidad no debe depender únicamente de una inspección final. Debe integrarse en requisitos, diseño, procesos, criterios de aceptación, pruebas y decisiones.
...
### Gestión de incertidumbre, riesgo y complejidad

La incertidumbre debe identificarse, analizarse y tratarse de manera continua. No todos los riesgos pueden eliminarse; algunos se evitan, reducen, transfieren, aceptan o explotan según su naturaleza.
...
Se debe medir aquello que ayude a decidir. Una métrica útil debe ser relevante, comprensible, oportuna y difícil de manipular.
...
Este apartado sirve como orientación inicial. El estudio detallado corresponde al tema de estándares y marcos de referencia.

### PMBOK 7.ª edición

La séptima edición articula **doce principios**:

1. Custodia responsable (*stewardship*).
2. Equipo.
3. Interesados.
4. Valor.
5. Pensamiento sistémico.
6. Liderazgo.
7. Adaptación al contexto.
8. Calidad.
9. Complejidad.
10. Riesgo.
...
La octava edición, publicada por PMI en noviembre de 2025, conserva la base orientada a principios y dominios, pero la simplifica en **seis principios nucleares**:
...
El alcance y la planificación se definen con alto detalle al comienzo. La entrega principal suele realizarse al final o en grandes hitos. Es apropiado cuando los requisitos son estables y el cambio es costoso.

### Iterativo

La solución se refina mediante ciclos repetidos. Cada iteración mejora la comprensión o el producto, aunque no necesariamente añade funcionalidad utilizable.

### Incremental

El producto se entrega por partes funcionales. Cada incremento añade capacidad utilizable.

### Adaptativo o ágil

Se trabaja en ciclos cortos, con priorización frecuente, retroalimentación continua y aceptación del cambio. Es adecuado cuando existe incertidumbre y es posible entregar valor gradualmente.

### Híbrido

Combina elementos predictivos y adaptativos. Puede aplicarse un enfoque predictivo para infraestructura, contratación o cumplimiento, y uno ágil para desarrollo de funcionalidades.

> **Clave de test:** iterativo e incremental no son sinónimos. Un enfoque puede ser iterativo, incremental o ambas cosas.

## 2.5.6. Según tamaño o complejidad
...
El **ciclo de vida del proyecto** es el conjunto de fases por las que pasa desde su inicio hasta su cierre. Las fases facilitan gobernanza, planificación, control y decisiones.

Una **fase** es un conjunto de actividades relacionadas que culmina con uno o varios entregables y, con frecuencia, con una decisión de continuar, modificar, suspender o cerrar.
...
Objetivo: determinar qué se pretende conseguir, por qué y bajo qué autoridad inicial.
...
Objetivo: definir cómo se alcanzarán los objetivos y cómo se gobernará y controlará el trabajo.
...
Objetivo: realizar el trabajo y producir los entregables.
...
Objetivo: comparar el desempeño con lo previsto, prever resultados y decidir acciones.

No tiene por qué ser una fase aislada; normalmente se realiza durante todo el proyecto.
...
Objetivo: confirmar la finalización ordenada, aceptar resultados y transferir responsabilidades.
...
Las fases pueden relacionarse de diferentes formas:

### Secuenciales

Una fase comienza después de finalizar la anterior. Reduce incertidumbre de coordinación, pero puede alargar el calendario.

### Solapadas

Una fase comienza antes de terminar la anterior. Puede reducir plazo, pero aumenta riesgo de retrabajo.

### Iterativas o adaptativas

Las fases o ciclos se repiten para desarrollar progresivamente el producto y aprender de la retroalimentación.

### Puertas de decisión o *stage gates*
...
Una fase pertenece a la estructura temporal del proyecto. Un proceso o grupo de procesos describe actividades de gestión que pueden repetirse dentro de varias fases.

Ejemplo: en un proyecto con fases de análisis, desarrollo y despliegue pueden realizarse actividades de planificación, ejecución y control en cada fase.
...
| **Ejemplo** | Proyecto para desarrollar la versión inicial de una aplicación. | Vida completa de la aplicación, incluidas nuevas versiones, operación y retirada. |
...
Los criterios de aceptación definen las condiciones que debe cumplir un entregable para ser aceptado. Deben ser claros, verificables y acordados con la autoridad correspondiente.

Ejemplo poco útil: «la aplicación será rápida».
...
Una **PMO** (*Project Management Office*) es una unidad, función o estructura organizativa que facilita, coordina, normaliza, supervisa o dirige aspectos relacionados con proyectos, programas o portafolios.
...
Conjunto de proyectos y actividades relacionadas que se gestionan coordinadamente para obtener beneficios que no se alcanzarían gestionándolos de forma independiente.
...
## 2.8.1. Concepto de operación

Las **operaciones** son actividades continuas o recurrentes que sostienen el funcionamiento habitual de una organización y producen bienes o servicios de manera repetitiva.
...
| **Repetitividad** | Menor; contexto y resultado singulares. | Mayor; procesos estables o repetibles. |
| **Equipo** | Puede formarse temporalmente y disolverse. | Suele pertenecer a una estructura permanente. |
| **Incertidumbre** | Generalmente mayor. | Generalmente menor, aunque nunca nula. |
| **Financiación** | Presupuesto acotado o inversión. | Presupuesto operativo periódico. |
| **Medición** | Entregables, hitos, resultados y beneficios. | Niveles de servicio, productividad, calidad y continuidad. |
...
Proyectos y operaciones se conectan en distintos momentos:

1. Una necesidad operativa origina un proyecto.
2. Personal de operaciones aporta requisitos y restricciones.
3. El proyecto prepara soporte, formación y transición.
4. Operaciones acepta el producto o servicio.
5. El uso operativo produce resultados y beneficios.
6. La experiencia operativa genera nuevas mejoras o proyectos.
...
Un proyecto puede contener tareas repetitivas, por ejemplo reuniones semanales, compilaciones o pruebas automatizadas. Su existencia no convierte el proyecto en una operación. Debe observarse la finalidad global y la temporalidad.
...
## 2.9.3. Dirección de proyectos frente a gestión de productos

- La dirección de proyectos se centra en lograr objetivos temporales y cerrar la iniciativa.
- La gestión de productos se centra en maximizar el valor del producto durante su ciclo de vida.

Ambas disciplinas colaboran, especialmente en entornos digitales.

## 2.9.4. Proyecto frente a programa

Un proyecto crea un resultado singular. Un programa coordina proyectos relacionados para lograr beneficios conjuntos y gestionar interdependencias.

## 2.9.5. Proyecto frente a portafolio
